  ...
  "decisions": [
    {
      ...
      "text": "**Problema**\n\nEl proceso original no estaba diseñado como un sistema de software. Muchas reglas existían como parte de la forma cotidiana de trabajar del negocio, no eran claras.\n\n**Decisión**\n\nAntes de implementar funcionalidades, fue necesario identificar entidades, relaciones, responsables y eventos importantes dentro de la operación.\n\nVentas, jornadas, facturas, usuarios, inventario y domicilios dejaron de verse como pantallas independientes y comenzaron a tratarse como partes de un mismo proceso.\n\n**Por qué**\n\nUna interfaz puede digitalizar un formulario, pero eso no significa que haya digitalizado correctamente el negocio.\n\nEl sistema necesitaba representar lo que ocurre antes, durante y después de cada venta.\n\n**Resultado**\n\nLas funcionalidades pudieron conectarse alrededor de un flujo operativo común en lugar de convertirse en módulos aislados."
    },
    {
      "title": "Modelar el consumo real de cada granizado",
      "text": "**Problema**\n\nUna venta no podía descontar inventario como una unidad simple. Cada vaso tiene un tamaño específico y consume una cantidad determinada de granizado proveniente de una bolsa de sabor.\n\n**Decisión**\n\nRelacioné el tamaño del vaso con su capacidad en mililitros y cada sabor con su inventario disponible, permitiendo calcular cuánto producto debía descontarse en cada venta.\n\n**Por qué**\n\nEl inventario debía representar el consumo real de materia prima y no solamente la cantidad de productos vendidos.\n\n**Resultado**\n\nCada venta actualiza automáticamente vasos y sabores según la composición real del producto."
    },
    {
      "title": "Definir correctamente el día operativo",
      "text": "**Problema**\n\nEl negocio podía seguir registrando ventas después de la medianoche. Una venta realizada, por ejemplo, a la 1:30 a. m. todavía pertenecía a la jornada del día anterior y no al nuevo día calendario.\n\n**Decisión**\n\nLa lógica de jornadas considera las ventas realizadas hasta las 2:00 a. m. como parte del día operativo anterior.\n\n**Por qué**\n\nEl sistema debía representar cómo funciona realmente el negocio, no limitarse al cambio de fecha del calendario.\n\n**Resultado**\n\nLas ventas nocturnas permanecen asociadas a la jornada correcta, evitando inconsistencias en cierres, caja y reportes."
    },
    {
      "title": "Restringir el acceso según los días laborales",
      "text": "**Problema**\n\nLas vendedoras no debían poder ingresar al sistema en días diferentes a los asignados en su programación laboral.\n\n**Decisión**\n\nRelacioné los días laborales configurados para cada vendedora con el proceso de autenticación para validar su acceso antes de permitir el ingreso.\n\n**Por qué**\n\nNo bastaba con mostrar u ocultar funcionalidades después del login; la restricción debía aplicarse desde el momento en que se intenta acceder al sistema.\n\n**Resultado**\n\nEl sistema controla automáticamente qué días puede ingresar cada vendedora según su configuración laboral."
    }
  ],
